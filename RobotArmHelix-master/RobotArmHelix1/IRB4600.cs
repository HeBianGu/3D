...
public class IRB4600
{
    ...
    public Model3DGroup RA { get; set; }
    public IRB4600()
    {
        ...
        this.RA = Initialize_Environment(modelsNames);
    }
    ...
    private Model3DGroup Initialize_Environment(List<string> modelsNames)
    {
        try
        {
            ...
            foreach (string modelName in modelsNames)
            {
                ...
                EmissiveMaterial emissMat = new EmissiveMaterial(new SolidColorBrush(mainColor) { Opacity = 0.3 });
                DiffuseMaterial diffMat = new DiffuseMaterial(new SolidColorBrush(mainColor) { Opacity = 0.3 });
                SpecularMaterial specMat = new SpecularMaterial(new SolidColorBrush(mainColor) { Opacity = 0.3 }, 200);
    ...
    public Vector3D AngleToTargetPoint(double[] angles)
    {
    ...
    public void Goto(Point3D targetPoint)
    {
